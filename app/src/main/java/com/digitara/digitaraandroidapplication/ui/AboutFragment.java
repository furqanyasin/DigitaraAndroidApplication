...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.tabIndicator = (TabLayout) root.findViewById(R.id.tab_indicator);
        this.tvNext = (TextView) root.findViewById(R.id.tv_next);
        this.screenPager = (ViewPager) root.findViewById(R.id.screen_viewpager);
        AboutScreenModel();
        return root;
    }
    ...
    private void AboutScreenModel() {
        ...
        AboutPagerAdapter aboutPagerAdapter2 = new AboutPagerAdapter(getContext(), mList);
        this.aboutPagerAdapter = aboutPagerAdapter2;
        this.screenPager.setAdapter(aboutPagerAdapter2);
        this.tabIndicator.setupWithViewPager(this.screenPager);
        this.tvNext.setOnClickListener(view -> {
            AboutScreenModel(mList, view);
        });
    }

    public void AboutScreenModel(List mList, View view) {
